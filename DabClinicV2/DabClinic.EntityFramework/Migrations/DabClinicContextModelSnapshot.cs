...
namespace DabClinic.EntityFramework.Migrations
{
    ...
    partial class DabClinicContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DabClinic.Domain.Models.Account", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DabClinic.Domain.Models.Appointment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DabClinic.Domain.Models.BookedService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DabClinic.Domain.Models.Clinic", b =>
                {
            ...
            modelBuilder.Entity("DabClinic.Domain.Models.ClinicService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DabClinic.Domain.Models.ClinicSlot", b =>
                {
                    b.Property<int>("SlotId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DabClinic.Domain.Models.ServiceCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DabClinic.Domain.Models.BookedService", b =>
                {
                    b.HasOne("DabClinic.Domain.Models.Appointment", "Appointment")
                        .WithMany("BookedServices")
                        .HasForeignKey("AppointmentId")
                        .IsRequired()
                        .HasConstraintName("FK__BookedSer__appoi__4222D4EF");

                    b.HasOne("DabClinic.Domain.Models.ClinicService", "Service")
                        .WithMany("BookedServices")
            ...
            modelBuilder.Entity("DabClinic.Domain.Models.ClinicService", b =>
                {
                    b.HasOne("DabClinic.Domain.Models.ServiceCategory", "Category")
